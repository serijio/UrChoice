...
public class MainScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a5_activity_main_screen);
        MtextView = findViewById(R.id.main_screen_title);
        mainCards = findViewById(R.id.main_cards);
        login_tapButton = findViewById(R.id.main_log_button);
        setDegradadoTitulo();
