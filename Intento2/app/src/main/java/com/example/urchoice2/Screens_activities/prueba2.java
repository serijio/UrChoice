...
public class prueba2 extends AppCompatActivity {
    ...
    public void changeToMainButton() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(prueba2.this, MainScreen.class);
                Pair[] pairs = new Pair[0];



                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(prueba2.this, pairs);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (currentRound < shuffledElements.size() / 2) {
                    ...
                    //winnerName.setText(shuffledElements.get(0).getName_elem());
                    Toast.makeText(prueba2.this , "Ha ganado : " + shuffledElements.get(0).getName_elem(), Toast.LENGTH_SHORT).show();
